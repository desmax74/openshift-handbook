...
```console 
kubectl apply -f scripts/kakfa/fedora/0.12.2/kafka/kafka-ephemeral.yaml -n my-kafka-project
```

#### Create the cluster persistent
```console 
kubectl apply -f scripts/kakfa/fedora/0.12.2/kafka/kafka-persistent-single.yaml -n my-kafka-project
```
