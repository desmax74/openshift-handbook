...
```console 
kubectl apply -f scripts/kakfa/ubuntu/0.12.1/kafka/kafka-ephemeral.yaml -n my-kafka-project
```

#### Create the cluster persistent
```console 
kubectl apply -f scripts/kakfa/ubuntu/0.12.1/kafka/kafka-persistent-single.yaml -n my-kafka-project
```
