...
```console 
kubectl apply -f scripts/kakfa/ubuntu/0.12.2/kafka-ephemeral.yaml -n my-kafka-project
```

#### Create the cluster persistent
```console 
kubectl apply -f scripts/kakfa/ubuntu/0.12.2/kafka-persistent-single.yaml -n my-kafka-project
```
